...
void main() {
  ...
  setUp(() {
    ...
    when(() => detailCubit.state)
        .thenReturn(const MovieDetailState.data(testMovieDetail));
  ...
  testWidgets(
      ...
      (WidgetTester tester) async {
    when(() => watchlistCubit.state)
        .thenReturn(const MovieDetailWatchlistState.data(true));
    ...
    whenListen(
      ...
      Stream.fromIterable(
        [
          ...
          const MovieDetailWatchlistState.success('Added to Watchlist')
        ],
      ),
    );
  ...
  testWidgets(
    ...
    whenListen(
      ...
      Stream.fromIterable(
        [
          const MovieDetailWatchlistState.data(false),
          const MovieDetailWatchlistState.error('Failed')
        ],
      ),
    );
